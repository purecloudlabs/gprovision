...
import (
	...
	"gprovision/pkg/appliance/altIdent"
...
//go:generate $GOPATH/../bin/go-bindata -prefix=$GOPATH/src/gprovision/proprietary/data/disk -pkg=$GOPACKAGE $GOPATH/src/gprovision/proprietary/data/disk

...
//
//    //go:generate $GOPATH/../bin/go-bindata -tags !light -prefix=$GOPATH/src/gprovision/proprietary/data/appliance -pkg=$GOPACKAGE $GOPATH/src/gprovision/proprietary/data/appliance
//
...
// ($GOPATH/src/gprovision/proprietary/data/appliance) with content like the
